        ...
        <div className="flex justify-between p-5  bg-slate-200">
            ...
            <nav className="lg:block hidden order-1">
                <ul className="flex">
                    ...
                    <li className="hover:text-sky-500"><NavLink to="/providers" ><span className="hover:text-sky-500">Providers</span></NavLink></li>
                    <li className="hover:text-sky-500"><NavLink to="/howitwork" ><span className="hover:text-sky-500">How it work</span></NavLink></li>
                    <li className="hover:text-sky-500"><NavLink to="about" ><span className="hover:text-sky-500">About</span></NavLink></li>
                </ul>
