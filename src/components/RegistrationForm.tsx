...
import { Button, Typography, TextField, Stack, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
...
const RegisterForm = () => {
    ...
    return (
        ...
        <form className="w-[400px]" onSubmit={handleSubmit(handleFormSubmit)} noValidate>
            <Stack spacing={4}>
